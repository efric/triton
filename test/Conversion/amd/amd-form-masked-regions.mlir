...
// CHECK: llvm.extractelement %[[REGION]]#0[%[[C0]] : i32] : vector<1xi32>
// CHECK: llvm.extractelement %[[REGION]]#1[%[[C0]] : i32] : vector<1xi32>
// CHECK-NOT: amdg.masked_load
// CHECK: llvm.return
module {
  llvm.func @escaped_extracts_between_loads(%active: i1, %src0: !llvm.ptr, %src1: !llvm.ptr, %dst: !llvm.ptr, %zero_vec: vector<1xi32>) {
...
// CHECK: llvm.return
module {
  llvm.func @hoist_false_values_defined_between_loads(%active: i1, %src0: !llvm.ptr, %src1: !llvm.ptr, %dst: !llvm.ptr, %other0: i32, %other1: i32) {
    %c0 = llvm.mlir.constant(0 : i32) : i32
    %undef0 = llvm.mlir.undef : vector<1xi32>
    %false0 = llvm.insertelement %other0, %undef0[%c0 : i32] : vector<1xi32>
    %v0 = amdg.masked_load %src0, %active, %false0 : (!llvm.ptr, i1, vector<1xi32>) -> vector<1xi32>
    %e0 = llvm.extractelement %v0[%c0 : i32] : vector<1xi32>
    %undef1 = llvm.mlir.undef : vector<1xi32>
    %false1 = llvm.insertelement %other1, %undef1[%c0 : i32] : vector<1xi32>
    %v1 = amdg.masked_load %src1, %active, %false1 : (!llvm.ptr, i1, vector<1xi32>) -> vector<1xi32>
    %e1 = llvm.extractelement %v1[%c0 : i32] : vector<1xi32>
    %sum = llvm.add %e0, %e1 : i32
    llvm.store %sum, %dst : i32, !llvm.ptr
    llvm.return
...
// CHECK: llvm.return
module {
  llvm.func @aggregate_masks_from_same_value_group(%active: i1, %src0: !llvm.ptr, %src1: !llvm.ptr, %dst: !llvm.ptr, %zero_vec: vector<1xi32>) {
    %c0 = llvm.mlir.constant(0 : i32) : i32
...
// CHECK-LABEL: llvm.func @scalarized_layout_masks_do_not_group
// CHECK-NOT: amdg.masked_region
// CHECK: amdg.masked_load
// CHECK: amdg.masked_load
// CHECK: llvm.return
module {
  llvm.func @scalarized_layout_masks_do_not_group(%row: i1, %pid_n: i32, %N: i32, %src0: !llvm.ptr, %src1: !llvm.ptr, %dst: !llvm.ptr) {
    %zero = llvm.mlir.constant(0 : i32) : i32
